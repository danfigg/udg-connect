<x-app-layout>
    <button class="my-3 mx-20 p-1 bg-gray-400 rounded-lg">
        ...
        <form action="{{ route('comunidades.store') }}" method="POST" class="space-y-3 mx-10">
            ...
            <div class="flex space-x-3">
                <div class="w-1/2 flex flex-col">
                    ...
                    <input type="text" name="nombre" id="nombre" class="border rounded-md px-2 py-1 text-sm">
                    @error('nombre')
            ...
            <div class="flex flex-col">
                ...
                <textarea name="descripcion" id="descripcion" cols="20" rows="5" class="border rounded-md px-2 py-1 text-sm resize-none"></textarea>
                @error('descripcion')
                    <p class="text-red-500">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="flex flex-col">
                ...
                <textarea name="reglas" id="reglas" cols="20" rows="5" class="border rounded-md px-2 py-1 text-sm resize-none"></textarea>
                @error('reglas')
                    <p class="text-red-500">{{ $message }}</p>
                @enderror
            </div>
